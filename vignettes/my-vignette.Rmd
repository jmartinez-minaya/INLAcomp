...
data_fixed <- rbind(#data.frame(inla.smarginal(model.typeI$marginals.fixed$intercept), var = "Intercept"),
                    data.frame(inla.smarginal(model.typeI$marginals.fixed$sc_bio1), var = "BIO1"),
...
### Posterior distribution of the fixed effects
```{r, fig.asp=0.5}
data_fixed <- rbind(data.frame(inla.smarginal(model.typeII$marginals.random$id.sc_bio1$index.1), alr = "alr(GC1/GC4)", 
                               var = "BIO1"),
                    data.frame(inla.smarginal(model.typeII$marginals.random$id.sc_bio1$index.2), alr = "alr(GC2/GC4)",
                               var = "BIO1"),
                    data.frame(inla.smarginal(model.typeII$marginals.random$id.sc_bio1$index.3), alr = "alr(GC3/GC4)",
                               var = "BIO1"),
                    data.frame(inla.smarginal(model.typeII$marginals.random$id.sc_bio12$index.1), alr = "alr(GC1/GC4)",
                               var = "BIO12"),
                    data.frame(inla.smarginal(model.typeII$marginals.random$id.sc_bio12$index.2), alr = "alr(GC2/GC4)",
                               var = "BIO12"),
                    data.frame(inla.smarginal(model.typeII$marginals.random$id.sc_bio12$index.3), alr = "alr(GC3/GC4)",
                               var = "BIO12"))
p_fixed <- ggplot() +
  geom_line(data = data_fixed, aes(x = x, y = y, col = var, linetype = var), size = 0.9) +
  #ggtitle("Effect of the covariate bio12") +
...
hyper.df$name1 <- ordered(hyper.df$name1,
                          levels = c("sigma2.1", "sigma2.2", "sigma2.3",
                                     "gamma", "phi", "sigma.sp"))
                          # labels = c("sigma^2[1]", "sigma^2[2]", "sigma^2[3]",
                          #            "eval(parse(text = expression(gamma)))", "phi", "sigma.sp"))
...
```{r, fig.asp=0.5}
##Bio12
data_fixed <- rbind(data.frame(inla.smarginal(model.typeIV$marginals.random$id.sc_bio1$index.1), alr = "alr(GC1/GC4)", 
                               var = "BIO1"),
                    data.frame(inla.smarginal(model.typeIV$marginals.random$id.sc_bio1$index.2), alr = "alr(GC2/GC4)",
                               var = "BIO1"),
                    data.frame(inla.smarginal(model.typeIV$marginals.random$id.sc_bio1$index.3), alr = "alr(GC3/GC4)",
                               var = "BIO1"),
                    data.frame(inla.smarginal(model.typeIV$marginals.random$id.sc_bio12$index.1), alr = "alr(GC1/GC4)",
                               var = "BIO12"),
                    data.frame(inla.smarginal(model.typeIV$marginals.random$id.sc_bio12$index.2), alr = "alr(GC2/GC4)",
                               var = "BIO12"),
                    data.frame(inla.smarginal(model.typeIV$marginals.random$id.sc_bio12$index.3), alr = "alr(GC3/GC4)",
                               var = "BIO12"))
p_fixed <- ggplot() +
  geom_line(data = data_fixed, aes(x = x, y = y, col = var, linetype = var), size = 0.9) +
  #ggtitle("Effect of the covariate bio12") +
...
### ------- 7.1.1. Fixed effects --- ####
##Bio12
data_fixed <- rbind(data.frame(inla.smarginal(model.typeVI$marginals.random$id.sc_bio1$index.1), alr = "alr(GC1/GC4)", 
                               var = "BIO1"),
                    data.frame(inla.smarginal(model.typeVI$marginals.random$id.sc_bio1$index.2), alr = "alr(GC2/GC4)",
                               var = "BIO1"),
                    data.frame(inla.smarginal(model.typeVI$marginals.random$id.sc_bio1$index.3), alr = "alr(GC3/GC4)",
                               var = "BIO1"),
                    data.frame(inla.smarginal(model.typeVI$marginals.random$id.sc_bio12$index.1), alr = "alr(GC1/GC4)",
                               var = "BIO12"),
                    data.frame(inla.smarginal(model.typeVI$marginals.random$id.sc_bio12$index.2), alr = "alr(GC2/GC4)",
                               var = "BIO12"),
                    data.frame(inla.smarginal(model.typeVI$marginals.random$id.sc_bio12$index.3), alr = "alr(GC3/GC4)",
                               var = "BIO12"))
p_fixed <- ggplot() +
  geom_line(data = data_fixed, aes(x = x, y = y, col = var, linetype = var), size = 0.9) +
  #ggtitle("Effect of the covariate bio12") +
...
### ------- 7.1.1. Fixed effects --- ####
##Bio12
data_fixed <- rbind(data.frame(inla.smarginal(model.typeVIII$marginals.random$id.sc_bio1$index.1), alr = "alr(GC1/GC4)", 
                               var = "BIO1"),
                    data.frame(inla.smarginal(model.typeVIII$marginals.random$id.sc_bio1$index.2), alr = "alr(GC2/GC4)",
                               var = "BIO1"),
                    data.frame(inla.smarginal(model.typeVIII$marginals.random$id.sc_bio1$index.3), alr = "alr(GC3/GC4)",
                               var = "BIO1"),
                    data.frame(inla.smarginal(model.typeVIII$marginals.random$id.sc_bio12$index.1), alr = "alr(GC1/GC4)",
                               var = "BIO12"),
                    data.frame(inla.smarginal(model.typeVIII$marginals.random$id.sc_bio12$index.2), alr = "alr(GC2/GC4)",
                               var = "BIO12"),
                    data.frame(inla.smarginal(model.typeVIII$marginals.random$id.sc_bio12$index.3), alr = "alr(GC3/GC4)",
                               var = "BIO12"))
p_fixed <- ggplot() +
  geom_line(data = data_fixed, aes(x = x, y = y, col = var, linetype = var), size = 0.9) +
  #ggtitle("Effect of the covariate bio12") +
...
<!-- # Predicting with the best model based on WAIC (Type VII) -->
...
<!-- grid.arrange(arrangeGrob(pred_plot_mean_alr[[1]] + theme(legend.position = "none"), -->
...
<!-- #       width = 12, height = 7) -->
<!-- grid.arrange(arrangeGrob(pred_plot_mean[[1]] + theme(legend.position = "none"), -->
